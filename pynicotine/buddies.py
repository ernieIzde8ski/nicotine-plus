...
from pynicotine.slskmessages import GetUserStatus, UserStatus
...
class Buddies:
    ...
    def remove_buddy(self, username: str):
    ...
    def set_buddy_notify(self, username: str, notify: bool):
    ...
    def set_buddy_prioritized(self, username: str, prioritized: bool):
    ...
    def set_buddy_trusted(self, username: str, trusted: bool):
    ...
    def _user_country(self, username: str, country_code: str):
    ...
    def _user_status(self, msg: GetUserStatus):
        """Server code 7."""
